...
// ** Reactstrap Imports
import { Table, Card, UncontrolledDropdown, DropdownToggle, DropdownMenu, DropdownItem } from 'reactstrap'

// ** Icons Imports
import { Monitor, Coffee, Watch, TrendingUp, TrendingDown, MoreVertical, Edit, Trash } from 'react-feather'
...
const CompanyTable = () => {
  ...
  const data = [
    ...
    // },
    // {
    //   img: require('@src/assets/images/icons/amazon.png').default,
    //   name: 'Cafés',
